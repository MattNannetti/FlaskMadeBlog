...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='gooserayder@gmail.com', recipients=[user.email])
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Thanks {form.username.data}! Your password has been updated, you are now able to log in.', 'success')
        return redirect(url_for('login'))
